...
/**
 * Wird geworfen, um darauf hinzuweisen, das eine ungültige Anzahl von Lagermitarbeitern eingegeben wurde
...
public class IllegalNubmberOfLMException extends IllegalArgumentException {
	...
	/**
	 * Default-Konstruktor, ruft den Konstruktor der super Klasse mit diesem String auf 'Ungültige Anzahl von Lagermitarbeitern!' aus
	 */
	public IllegalNubmberOfLMException() {
		super("Ungültige Anzahl von Lagermitarbeitern!");
	}
